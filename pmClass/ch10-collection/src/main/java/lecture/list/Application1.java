...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("list의 크기 : " + list.size()); //size는 요소의 개수를 반환함

        list.add(1,"banana");
        System.out.println(list);

        list.set(1,true); //set에는 인덱스랑 바꿀 값을 넣어줌
        System.out.println(list);
        ...
        * - 요소의 저장과 삭제가 빈번히 일어날 때 성능 면에서 ArrayList보다 우수
        * */
